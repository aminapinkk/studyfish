...
Если материал находится на фотографии, внимательно прочитай весь видимый текст.
...
Для каждого вопроса обязательно используй такой JSON-формат:
...
correctIndex — номер правильного варианта:
0 = первый
1 = второй
2 = третий
3 = четвёртый
...
[
  {
    ...
    "correctIndex": 0,
    "explanation": "HTML используется для разметки веб-страниц."
  }
]
...
Если материал находится на фотографии, внимательно прочитай его.
